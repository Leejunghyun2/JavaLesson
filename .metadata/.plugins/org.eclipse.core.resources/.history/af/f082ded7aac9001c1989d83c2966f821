...
public class PhoneBookManager {
	...
	void updateData() {
		...
		if (index > -1) {
			...
			if(infoStorage[index] instanceof UnivFriends) {
				
				UnivFriends tmp = null;
				tmp = (UnivFriends)infoStorage[index];
			...
			}else if(infoStorage[index] instanceof CompanyFriends){
				CompanyFriends tmp = null;
				tmp = (CompanyFriends)infoStorage[index];
